...
for i in range(1,length(orders))
    ...
    export_data((gaps[i],), (labels_filename[i],), filename_prefix=string("DC_adaptive_A",num_trials,"_",n,"_"),filename_suffix=filename_suffix,compute_FWgaps=compute_FWgaps,iter_skip=convert(Int,ceil(max_iters[i]/100)))
    println("Done.")
end
end
